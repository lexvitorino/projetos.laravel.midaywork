    ...
    <form action="{{ route('users.store') }}" method="POST">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="name" name="name" placeholder="Informe o nome" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}">
            </div>
            <div class="form-group col-md-6">
                <label for="email">E-mail</label>
                <input type="email" id="email" name="email" placeholder="Informe o email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="password">Senha</label>
                <input type="password" id="password" name="password" placeholder="Informe a senha" class="form-control @error('password') is-invalid @enderror" />
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="form-row">
            <div class="col-md-6">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" id="time_balance" name="time_balance" placeholder="Informe o saldo de horas" class="form-control" value="{{ old('time_balance') }}">
                </div>
            </div>
        </div>
        <div class="form-row">
